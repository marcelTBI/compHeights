/*
  ...
  gengetopt -i compHeights.ggo --file-name=compHeights_cmdline --include-getopt --default-optional --unamed-opts
...
const char *gengetopt_args_info_purpose = "coparator for energy heights";

const char *gengetopt_args_info_usage = "Usage: compHeights [OPTIONS]... [FILES]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -b, --barriers=STRING  barrier filebuf to caompare  (default=`barriers.txt')",
    0
};
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->barriers_arg = gengetopt_strdup ("barriers.txt");
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVb:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'b':	/* barrier filebuf to caompare.  */
        
        
          if (update_arg( (void *)&(args_info->barriers_arg), 
               &(args_info->barriers_orig), &(args_info->barriers_given),
              &(local_args_info.barriers_given), optarg, 0, "barriers.txt", ARG_STRING,
